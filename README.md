...
- **Technical Analysis & Strategies**: Built-in support for Moving Averages (SMA), RSI-based variants (RSI SMA, Two Bands, Rollercoaster), and scale-invariant logarithmic Mogalef Bands with timeframe-differentiated stop-loss clamping (Daily 12% / Weekly 18%) used as protective barriers for RSI band strategies, guaranteeing strictly positive lower bands, eliminating catastrophic tail losses, and preserving tighter corridors (see [Logarithmic Mogalef Bands Guide](docs/mogalef_bands_logarithmic_scale.md) and [Stop-Loss Clamping Guide](docs/timeframe_differentiated_stop_loss_clamping.md)). RSI Two Bands incorporates timeframe-adaptive 3-bar Daily Dwell Persistence to eliminate false-positive entry flickers (see [Daily Dwell Persistence Guide](docs/rsi_two_bands_daily_dwell_persistence.md)).
