...
- **Modular Input Filtering**: Trade entry confirmation filters (Price Action candle confirmation, ATR volatility regime, SMA 200 trend) with timeframe-level precomputed boolean masks and zero-allocation baseline bypass.
...
- **Configurable settings**: Symbols, shortable assets, verbosity, concurrency, enabled strategies, and input confirmation filters.
