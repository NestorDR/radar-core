...
For details, see the [Strategy Implementation Overview](docs/strategy-implementation-overview.md) and [Trade Performance Percentage Ratios Architecture](docs/trade_performance_percentage_ratios.md).
